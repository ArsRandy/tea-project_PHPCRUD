    ...
    <div class="container">
	  ...
	  <tr>
		...
		<div class="login-wrap">
            ...
            <input name="m_name" type="text" class="form-control" id="m_name" value="<?php echo $row_RecMember["m_name"];?>"placeholder="請填入姓名"><font color="#FF0000">*</font></p>

            <p>性　　別：
            <label><input name="m_sex" type="radio" class="radioed" value="女" <?php if($row_RecMember["m_sex"]=="女") echo "checked";?>>女</label>
            ...
            <textarea name="m_url" rows="10" cols="48" type="text" class="form-control" id="m_url" value="<?php echo $row_RecMember["m_url"];?>" placeholder="個人簡介" ></textarea>
			</p></label>
